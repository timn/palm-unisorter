/* $Id: quicksort.h,v 1.1.1.1 2003/02/10 23:15:15 tim Exp $
 *
 * Uni Sorter
...
extern void quicksort(Int8 *values);
extern void quicksort_median(Int8 *values);
extern void quicksort_rect(Int8 *values);
